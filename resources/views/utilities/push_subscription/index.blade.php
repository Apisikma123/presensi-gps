        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center py-2" style="min-height: 50px;">
                <div class="d-flex align-items-center">
                    ...
                    <h6 class="card-title mb-0">Data Push Subscriptions</h6>
                </div>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="py-3 border-start">ENDPOINT BROWSER</th>
                                <th class="py-3 border-start">TERAKHIR DIPERBARUI</th>
                                <th class="py-3 border-start text-center" width="100">AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
