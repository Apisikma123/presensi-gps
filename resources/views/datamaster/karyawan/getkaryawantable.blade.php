<div class="card border-0 shadow-none">
    ...
    <div class="card-header border-0 pb-3" style="border-radius: 8px 8px 0 0;">
        <div class="row align-items-center">
            <div class="col-md-6 mb-2 mb-md-0 text-start">
                ...
                <h5 class="mb-0 fw-bold">Cari Data Karyawan</h5>
            </div>
            <div class="col-md-6">
    ...
    <div class="table-responsive" style="max-height: 450px; overflow-y: auto;">
        <table class="table table-hover mb-0 text-nowrap align-middle" id="tableKaryawanLookup">
            <thead class="sticky-top" style="top: -1px; z-index: 10;">
                <tr>
                    <th class="border-0 py-2 ps-4" style="font-size: 0.7rem; letter-spacing: 0.5px;" width="50">FOTO</th>
                    <th class="border-0 py-2" style="font-size: 0.7rem; letter-spacing: 0.5px;" width="100">NIK</th>
                    <th class="border-0 py-2" style="font-size: 0.7rem; letter-spacing: 0.5px;">NAMA KARYAWAN</th>
                    <th class="border-0 py-2" style="font-size: 0.7rem; letter-spacing: 0.5px;">JABATAN</th>
                    <th class="border-0 py-2" style="font-size: 0.7rem; letter-spacing: 0.5px;">DEPARTEMEN</th>
                    <th class="border-0 py-2" style="font-size: 0.7rem; letter-spacing: 0.5px;">CABANG</th>
                    <th class="border-0 py-2 text-center pe-4" style="font-size: 0.7rem; letter-spacing: 0.5px;" width="50">PILIH</th>
                </tr>
            </thead>
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td class="py-2 ps-4 text-center">
                        ...
                        @else
                            <div class="avatar avatar-sm">
                                <img src="{{ $path }}" class="rounded-circle" style="object-fit: cover;" onerror="this.onerror=null;this.parentElement.innerHTML='<span class=\'avatar-initial rounded-circle {{ $randomColor }}\' style=\'font-size: 0.6rem;\'>{{ $initials }}</span>';">
                            </div>
                        @endif
                    </td>
                    <td class="py-2">
    ...
    <!-- Info Footer -->
    <div class="card-footer border-0 py-2 text-center" style="border-top: 1px solid rgba(255,255,255,0.1) !important;">
