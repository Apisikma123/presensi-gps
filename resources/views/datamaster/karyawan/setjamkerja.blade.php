...
<script>
    $(document).ready(function() {
        // Clean up any previously registered event handlers to prevent duplication when modal is reloaded
        $(document).off('.setjamkerja');
        $('#modalSetJamkerja').off('.setjamkerja');
        $('button[data-bs-target="#navs-top-profile"]').off('.setjamkerja');
        ...
        $('#modalSetJamkerja').on('shown.bs.modal.setjamkerja', function() {
        ...
        $('button[data-bs-target="#navs-top-profile"]').on('click.setjamkerja', function() {
            setTimeout(function() {
                // Initialize dropdown values
                const currentDate = new Date();
                const currentMonth = currentDate.getMonth() + 1;
        ...
        function setupSelectionModeHandlers() {
            ...
            $(document).off('click.setjamkerja', '.calendar-day').on('click.setjamkerja', '.calendar-day', function(e) {
            ...
            $(document).off('mousedown.setjamkerja', '.calendar-day').on('mousedown.setjamkerja', '.calendar-day', function(e) {
                if (!selectionMode) return;
                if ($(e.target).closest('.jam-kerja-badge').length) return;
            ...
            $(document).off('mouseenter.setjamkerja', '.calendar-day').on('mouseenter.setjamkerja', '.calendar-day', function(e) {
            ...
            $(document).on('mouseup.setjamkerja', function() {
                isSelecting = false;
            });
        ...
        $(document).on('change.setjamkerja', '#bulan, #tahun', function() {
        ...
        $(document).on('click.setjamkerja', '#btnPrevMonth', function() {
        ...
        $(document).on('click.setjamkerja', '#btnNextMonth', function() {
        ...
        $(document).on('click.setjamkerja', '#btnToday', function() {
        ...
        $(document).on('click.setjamkerja', '.delete-jam-kerja', function(e) {
            e.preventDefault();
            e.stopPropagation();
        ...
        // Handled in the namespaced document change event handler
        ...
        $(document).on("click.setjamkerja", ".deletejamkerjabydate", function(e) {
