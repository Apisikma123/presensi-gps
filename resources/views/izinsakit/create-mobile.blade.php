    ...
    <div class="fade-up form-container">
        <form action="{{ route('izinsakit.store') }}" method="POST" id="formIzin" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="mobile-upload-box" id="mobileUploadDropzone">
                ...
                <div class="mobile-upload-title flex items-center justify-center gap-1.5">
                    <span>Upload Surat Dokter (SID)</span>
                    <span class="opt-tag font-semibold">(Opsional)</span>
                </div>
                <div class="mobile-upload-hint">Ketuk untuk memilih foto dokumen • Format WebP, JPG, PNG (Maks. 2MB)</div>
            </div>
            ...
            <div class="form-label-group">
                ...
                <label for="keterangan">Keterangan Sakit <span class="req-star">*</span></label>
            </div>
            ...
            form.addEventListener('submit', function(e) {
                ...
                .then(async (response) => {
                    ...
                    if (!response.ok || !data.success) {
                        throw new Error(data.message || 'Gagal menyimpan pengajuan sakit');
                    }
                    if (typeof window.hideGlobalLoading === 'function') window.hideGlobalLoading();
                    Swal.fire({
                        title: 'Berhasil Diajukan!',
                        text: data.message || 'Pengajuan sakit Anda telah berhasil dikirim.',
                        icon: 'success',
